...
Section PROOF.
  ...
  Proof using fvars_correct.
    ...
    rewrite
       ...
       /exec_sopn /= hw0 hw1 /=
       /sopn_sem /sopn_sem_ /= /size_8_64 hws /=.
    by rewrite /semi_to_atype_t /= computational_eq_refl /= sub_wordE.
  Qed.
  ...
  Proof.
    ...
    * have! := (is_wconstP true gd s Heq); t_xrbindP => v1 h1 hz [<- <-].
      ...
      rewrite /semi_to_atype_t !computational_eq_refl /=.
  ...
  Local Opaque convertible.
    ...
    + case: x => - [] [] [] // sz vn vi vs //= /[dup] ok_v.
      ...
      * move => h; eexists; first reflexivity.
      ...
      case: ty hty => //= _ [->].
      case: ifP => h128_le_sz''.
      * rewrite /= ok_v /exec_sopn /sopn_sem /sopn_sem_ /= /semi_to_atype_t computational_eq_refl.
    ...
    + rewrite /=; apply: rbindP => - [] // len a /= ok_a; t_xrbindP => i j ok_j ok_i w ok_w ?; subst v.
      ...
      * rewrite hty.
      ...
      case: ty hty => //= _ [->].
      case: ifP => h128_le_sz'.
      * rewrite /= ok_a ok_j /= ok_i /= ok_w /exec_sopn /sopn_sem /sopn_sem_ /= /semi_to_atype_t computational_eq_refl.
    ...
    + rewrite /=; t_xrbindP => ?? he hz w hload ?; subst v; case: ifP => hsz.
      ...
      * rewrite hty.
      ...
      rewrite /= he /= hz /= hload /exec_sopn /sopn_sem /sopn_sem_ /= /semi_to_atype_t computational_eq_refl.
    ...
    + case: o => //.
      ...
      + rewrite /= /sem_sop1 /=; t_xrbindP => sz sz' x ok_x x' /to_wordI' [szx [wx [hle ??]]] ?.
        ...
        - case: andP => // - [] hs hc.
          ...
          by rewrite /= ok_x /= zero_extend_sign_extend /exec_sopn //= truncate_word_le // {hle}
           /sopn_sem /sopn_sem_ /= /semi_to_atype_t !computational_eq_refl /size_MOVSX /x86_MOVSX /size_16_64 hs.
        - case: andP => // - [] hs hc.
          move: hty; rewrite -(convertible_eval_atype hc) => -[?]; subst sz'.
          by rewrite /= ok_x /= zero_extend_sign_extend /exec_sopn //= truncate_word_le // {hle}
            /sopn_sem /sopn_sem_ /= /semi_to_atype_t !computational_eq_refl /size_MOVSX /x86_MOVSX /size_16_64 hs.
        ...
        by rewrite /= ok_x /= zero_extend_sign_extend // /exec_sopn /= truncate_word_le //
           /sopn_sem /sopn_sem_ /= /semi_to_atype_t !computational_eq_refl /size_MOVSX /x86_MOVSX /size_32_64 hs.
      (* Ozeroext *)
      + rewrite /= /sem_sop1 /=; t_xrbindP => sz sz' x ok_x x' /to_wordI' [szx [wx [hle ??]]] ?.
        subst x x' v.
        ...
        - case: andP => // - [] hs hc.
          move: hty; rewrite -(convertible_eval_atype hc) => -[?]; subst sz'.
          rewrite /= ok_x /= zero_extend_u /exec_sopn /= truncate_word_le // {hle} /sopn_sem /sopn_sem_ /= /semi_to_atype_t !computational_eq_refl.
      ...
      + rewrite /= /sem_sop1 /= => sz; t_xrbindP => w Hz z' /to_wordI' [sz' [z [Hsz ? ->]]] ?; subst.
        ...
        by rewrite /sem_pexprs /= Hz /exec_sopn /= truncate_word_le // /= /sopn_sem /sopn_sem_ /=
          /semi_to_atype_t computational_eq_refl /x86_NOT /size_8_64 hsz.
      (* Oneg *)
      + rewrite /= /sem_sop1 /= => - [] // sz; t_xrbindP => w Hv z' /to_wordI' [sz' [z [Hsz ? ->]]] ?; subst.
        ...
        by rewrite /sem_pexprs /= Hv /exec_sopn /= truncate_word_le // /sopn_sem /sopn_sem_ /=
          /semi_to_atype_t !computational_eq_refl /size_8_64 hsz /= Hw.
    + case: o => // [[] sz |[] sz|[] sz|u []// sz| u []// sz|sz|sz|sz|sz|sz|sz|sz|sz| ve sz | ve sz | ve sz | ve sz | ve sz | ve sz] //.
      ...
      (* Oadd Op_w *)
        ...
        * rewrite add_wordE.
        ...
        by rewrite /= ok_v1 ok_v2 /= /exec_sopn /= /sem_sopn /= !truncate_word_le // /= /sopn_sem /sopn_sem_ /=
          /semi_to_atype_t !computational_eq_refl /= /size_8_64 hsz64 /= Hw.
      (* Omul Op_w *)
      + rewrite /= /sem_sop2 /=; t_xrbindP => v1 ok_v1 v2 ok_v2.
        move => ? /to_wordI' [w1] [z1] [hle1 ??]; subst.
        move => ? /to_wordI' [w2] [z2] [hle2 ??]; subst.
      ...
      + rewrite /= /sem_sop2 /=; t_xrbindP => v1 ok_v1 v2 ok_v2.
        ...
        * move: ok_v2 => /ok_word_inj [??]; subst.
          rewrite ok_v1 /= /exec_sopn /sopn_sem /sopn_sem_ /= /semi_to_atype_t !computational_eq_refl.
        ...
        * move: ok_v2 => /ok_word_inj [??]; subst.
        ...
        + split. by rewrite read_es_swap.
          by rewrite /= ok_v1 ok_v2 /= /exec_sopn /sopn_sem /sopn_sem_ /= /semi_to_atype_t !computational_eq_refl
      ...
      + case handn : is_andn => [[a1 a2] | ].
        + move=> he.
          ...
          + case hty32: (_ ≤ _)%CMP => //=.
            ...
            rewrite /exec_sopn /sopn_sem /sopn_sem_ /= /semi_to_atype_t !computational_eq_refl ha1 /= ha2 /= hva1 /= hva2 /=.
      ...
      + case good_shift: check_shift_amount => [ sa | ]; last by [].
        ...
        rewrite /sem_sop2 /exec_sopn /sopn_sem /sopn_sem_ /= /semi_to_atype_t !computational_eq_refl.
  ...
  Proof.
    by move=> hws he hx; rewrite /mov_ws; case: ifP => [ /andP [] _ h | _] /=;
     rewrite /sem_sopn /= /exec_sopn /=;
      move: he; t_xrbindP => _ -> /= -> /=;
      rewrite /sopn_sem /sopn_sem_ /= /semi_to_atype_t computational_eq_refl /x86_MOVX /x86_MOV /size_32_64 /size_8_64 hws ?h /= hx.
  Qed.
  ...
  Proof using fvars_correct.
    ...
    + move=> b [tw hty'] [hle'] [sz'] [w] [hsz' ?]; subst v.
      ...
      * set wtmp := {| v_var := _ |}.
        ...
        eexists; split.
        + rewrite /= /sem_sopn /sem_pexprs /= h /= /exec_sopn /sopn_sem /sopn_sem_ /= /semi_to_atype_t computational_eq_refl truncate_word_le // {hsz}.
    ...
    + move => sz [d b sc o] /= [hsz] [Hsc] [hrl] [w [? Hslea]]; subst v'; set f := Lnone_b _.
      ...
      + rewrite /sem_pexprs /= Hvb Hvo /= /exec_sopn /sopn_sem /sopn_sem_ /= /semi_to_atype_t computational_eq_refl /sem_sop2 /= !truncate_word_le // /=.
      ...
      + subst d; case: eqP => [ ? | _].
        + subst sc; exists s2' => //=.
          move: Hw';
            rewrite /sem_sopn /sem_pexprs /exec_sopn /sopn_sem /sopn_sem_ /= /semi_to_atype_t !computational_eq_refl
              Hvb Hvo /= Hwb Hwo /= /=.
      ...
      + subst d; exists s2'; split => //=.
        by rewrite /sem_sopn /sem_pexprs /exec_sopn /sopn_sem /sopn_sem_ /= /semi_to_atype_t !computational_eq_refl
      ...
      case: eqP => [ Ed | _ ].
      + exists s2'; split => //=.
        rewrite /sem_sopn /sem_pexprs /exec_sopn /sopn_sem /sopn_sem_ /= /semi_to_atype_t !computational_eq_refl Hvb /= Hwb /=.
      ...
      + rewrite /= /sem_sopn /exec_sopn /= truncate_word_u /= wrepr_unsigned -/(pwrepr64 _) write_var_eq_type //=.
        rewrite /sopn_sem /sopn_sem_ /= /semi_to_atype_t !computational_eq_refl.
        rewrite /get_gvar get_var_eq //= cmp_le_refl orbT //=.
    ...
    + move=> t cond e1 e2 [Hsz64] [He] [Hsz] [sz' Ht]; subst e.
      ...
      rewrite /exec_sopn /sopn_sem /sopn_sem_ /= /semi_to_atype_t !computational_eq_refl /x86_CMOVcc.
    ...
    + move=> d u w s p0 p1 /= [[va [wa [hva hwa hdiv]]] _ hle1 hle2].
      ...
      + rewrite /i1 /va0; case: (u); eexists; split.
        + by rewrite /i1 /= /sem_sopn /exec_sopn /sopn_sem /sopn_sem_ /= /semi_to_atype_t computational_eq_refl
  ...
  Proof.
          ...
          write_lvals true gd si' [:: f ; cf ; f ; f ; f ; r ] v' = ok so) as D.
    {
      ...
      + move: hv hx; rewrite /exec_sopn /sopn_sem; t_xrbindP; case: sub => _ hval <- y hy;
        ...
        rewrite /= /sopn_sem /sopn_sem_ /= /semi_to_atype_t !computational_eq_refl
          !truncate_word_le // {hsz1 hsz2} /semi /mk_semi /size_8_64 hsz64 /=; eexists; split; first reflexivity.
      ...
      subst x y v;
      rewrite /= /sopn_sem /sopn_sem_ /= /semi_to_atype_t !computational_eq_refl
        !truncate_word_le // {hsz1 hsz2} /semi /mk_semi /size_8_64 hsz64 /=;
      eexists; split; first reflexivity;
      rewrite //=.
  ...
  Proof.
    ...
    + move: Hv; rewrite /exec_sopn /sopn_sem ; t_xrbindP => _ hval <- y hy.
      ...
      + move => /(_ _ erefl) /=; rewrite He2 /= truncate_word_le // => - [?]; subst n2.
        ...
        * by move: Hdisje; rewrite (disj_fvars_m (read_es_cons _ _)) => /disjoint_union [].
        ...
        eexists; split.
        + rewrite /sem_sopn /sem_pexprs /= He2 /= /exec_sopn /sopn_sem /sopn_sem_ /= /semi_to_atype_t !computational_eq_refl
            !truncate_word_le // /= /x86_MOV /size_8_64 hsz64 /=.
          rewrite write_var_eq_type //=.
          rewrite /= /read_es /= in Hdisje.
          rewrite He1' /=.
          rewrite /get_gvar get_var_eq /= cmp_le_refl orbT //.
          rewrite /sopn_sem_ /= !truncate_word_le // hsz /= zero_extend_u /wmulhu mul_wordE wmulE LetK.
          exact: Hw''.
        exact: (eeq_excT Hs2' Hs3'').
      exists s2'; split=> //.
      rewrite /= /sem_sopn Hx' /= /exec_sopn /sopn_sem /sopn_sem_ /= /semi_to_atype_t !computational_eq_refl
    ...
    + by rewrite /exec_sopn /sopn_sem /sopn_sem_ /= /semi_to_atype_t computational_eq_refl /x86_XCHG /size_8_64 hle.
    by rewrite Hv /= Hw'.
  Qed.
