...
Section PROOF.
  ...
  Proof.
  case: l => /= [ _ [] // sz' | [[vt vn] vi] | al sz' [[vt vn] vi] e | aa sz' [[vt vn] vi] e |  aa sz' len [[vt vn] vi] e ] /=.
  ...
  Proof.
    ...
    move: e Hs=> [z|b|n|x|aa ws x e | aa ws len x e |al sz x e| o e|o e1 e2| op es |e e1 e2] //.
