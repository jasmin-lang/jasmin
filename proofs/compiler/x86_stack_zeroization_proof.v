  ...
  have [s2 [hsem hsr]]:
    [elaborate
      exists s2,
        ...
        state_rel_unrolled_small rspn ws_align ws stk_max ptr vars (Estate scs m vm) s2 0 ptr].
    ...
    + move=> [hcmd].
      ...
      have [s2 [hsem hsr]] :=
        loopP lt_0_stk_max halign le_ws_ws_align hlfd hstack hlabel hcmd
          hbody rsp_nin (s1 := Estate scs _ vm) hvalid hrsp.
      exists s2; split=> //.
      by case: hsr.
    + move=> [].
