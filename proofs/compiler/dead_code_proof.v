...
Section PROOF.
  ...
  Proof. by move=> s1 s2 vm' Hvm; exists vm'; split=> //; constructor. Qed.
  ...
  Proof.
    ...
    eexists; split; last exact: Eskip. by apply: uincl_onT Hvm.
  Qed.
  ...
  Proof.
    ...
    have /= := Hw ii sv0;rewrite Hloop /= => /(_ _ Hvm3'1) [vm4' [Hvm4'1 /semE Hvm4'2]].
    exists vm4';split => //.
