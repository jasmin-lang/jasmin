...
Definition is_andn  a b :=
  ...
  | None  , Some b => (Some (b, a), LT_seq [:: LT_subi 1; LT_subi 0 ])
...
#[local]
Notation LT_iaddcarryf ltes := (map (LT_compose (LT_map [:: LT_seq [:: LT_subi 0; LT_subi 1 ]; LT_seq [:: LT_remove ; LT_subi 0; LT_remove ; LT_remove ; LT_remove ; LT_subi 1] ])) ltes).
#[local]
Notation LT_iaddcarry ltes := (map (LT_compose (LT_map [:: LT_id; LT_seq [:: LT_remove ; LT_subi 0; LT_remove ; LT_remove ; LT_remove ; LT_subi 1] ])) ltes).
#[local]
Notation LT_ianone := ([:: LT_id ]).
#[local]
Notation LT_imul1 := ([:: LT_seq [:: LT_seq [:: LT_compose (LT_subi 0) (LT_subi 0) ] ; LT_seq [:: LT_remove ] ]; LT_seq [::LT_seq [:: LT_compose (LT_subi 0) (LT_subi 1); LT_remove ]; LT_seq [::LT_remove ; LT_remove ; LT_remove ; LT_remove ; LT_remove; LT_compose (LT_subi 1) (LT_subi 0) ; LT_compose (LT_subi 1) (LT_subi 1)] ]]).
#[local]
Notation LT_imul2 := ([:: LT_seq [:: LT_seq [:: LT_compose (LT_subi 0) (LT_subi 1) ] ; LT_seq [:: LT_remove ] ] ; LT_seq [::LT_seq [:: LT_compose (LT_subi 0) (LT_subi 0); LT_remove ]; LT_seq [::LT_remove ; LT_remove ; LT_remove ; LT_remove ; LT_remove; LT_compose (LT_subi 1) (LT_subi 0) ; LT_compose (LT_subi 1) (LT_subi 1)] ]]).
#[local]
Notation LT_imul3 := ([:: LT_seq [:: LT_subi 0 ; LT_seq [:: LT_remove ; LT_remove ; LT_remove ; LT_remove ; LT_remove; LT_compose (LT_subi 1) (LT_subi 0) ; LT_compose (LT_subi 1) (LT_subi 1) ] ] ]).
#[local]
Notation LT_iemptysl := ([::]).

#[local]
Notation LT_ilmul lest ltes := (LT_iopn (map (LT_compose (LT_map [:: lt_compose (LT_seq [:: LT_remove ; LT_remove ]) ltes ; LT_seq [:: LT_remove; LT_remove; LT_remove; LT_remove; LT_remove; LT_id ] ])) lest)).
#[local]
Notation LT_ilfopn lest lte := (LT_iopn (map (LT_compose (LT_map [:: lte ; LT_seq [:: LT_remove; LT_remove; LT_remove; LT_remove; LT_remove; LT_id ] ])) lest)).
#[local]
Notation LT_ilif lti le' := (LT_iopn ((map (LT_compose (LT_compose (LT_subi 0) (LT_subi 0))) lti) ++ [:: LT_seq [:: LT_seq [:: lt_compose (LT_compose (LT_subi 0) (LT_subi 0)) le'; LT_compose (LT_subi 0) (LT_subi 1) ; LT_compose (LT_subi 0) (LT_subi 2)] ; LT_seq [:: LT_subi 1 ] ] ])).
