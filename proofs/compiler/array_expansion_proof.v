...
Local Opaque wsize_size.
  ...
  rewrite Z2N.id // /arr_size /= Z2N.id; last by apply (Z.lt_le_incl _ _ vai.(len_pos)).
  move=> hi.
...
Proof.
  ...
  rewrite Z2N.id // /arr_size /mk_scale {1}Z2N.id; last by apply (Z.lt_le_incl _ _ lt0len).
