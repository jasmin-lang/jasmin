...
Definition Ox86_IMULr_instr             :=
  mk_instr_w2_b5w_010 "IMULr" x86_IMULt
    (fun _ => [::r_rm]) (prim_16_64 IMULr) size_16_64 (pp_iname "imul") [::IBool true; IBool true; IBool false; IBool false; IBool false; IBool true].

Definition Ox86_IMULri_instr :=
  mk_instr_w2_b5w "IMULri" x86_IMULt [:: Eu 1; Eu 2] [:: Eu 0] 3
  (fun sz => [:: [::r; rm true; i (max_32 sz)]]) (prim_16_64 IMULri) size_16_64 (pp_iname "imul") [:: IBool true; IBool true; IBool false; IBool false; IBool false; IBool true].
...
Definition Ox86_VPTEST_instr :=
  (fun sz => mk_instr_safe
               ...
               (size_128_256 sz) (pp_name "vptest" sz) [::IBool true; IBool true; IBool true; IBool true; IBool true]
               , ("VPTEST"%string, prim_128_256 VPTEST)).
