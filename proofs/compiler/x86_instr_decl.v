...
Definition safe_shxd sz : seq (safe_cond positive) :=
  match sz with
...
Lemma safe_wf_shxdP ws : all (λ sc : safe_cond positive, values.sc_needed_args sc <= size (w2w8_ty ws)) (safe_shxd ws).
Proof. by case: ws. Qed.
