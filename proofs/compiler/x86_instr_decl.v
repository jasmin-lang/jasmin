...
Notation mk_instr_safe str_jas tin tout ain aout msb semi args_kinds nargs valid pp_asm init_cond :=
  (mk_instr str_jas tin tout ain aout msb (sem_prod_ok tin semi) args_kinds nargs [::] init_cond valid pp_asm
    refl_equal
...
Definition Ox86_BSR_instr :=
  (fun sz =>
     mk_instr (pp_sz "BSR" sz) [:: sword sz ] (b5w_ty sz) [:: Eu 1 ] (implicit_flags ++ [:: Ea 0 ]) MSB_CLEAR
       (@x86_BSR sz) [:: r_rm ] 2 [:: NotZero sz 0 ] [::IBool false; IBool false; IBool false; IBool false; IBool true] 
      (size_16_64 sz) (pp_iname "bsr" sz)
