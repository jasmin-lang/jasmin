  ...
  let name := "MULX"%string in
   ((fun (sz:wsize) =>
     mk_instr (pp_sz name sz) (w2_ty sz sz) (w2_ty sz sz)
         ...
         (@x86_MULX sz) check_mulx 3 sz [::] (pp_iname "mulx" sz)),
    (name, PrimP U64 MULX)).
...
Definition Ox86_CLFLUSH_instr :=
  mk_instr_pp "CLFLUSH" [:: sword Uptr ] [::] [:: Ec 0 ] [::] MSB_CLEAR (λ _, ok tt) [:: [:: m true ] ] 1 Uptr (PrimM CLFLUSH) (pp_name "clflush" Uptr).

Definition Ox86_LFENCE_instr :=
  mk_instr_pp "LFENCE" [::] [::] [::] [::] MSB_CLEAR (ok tt) [:: [::] ] 0 U8 (PrimM LFENCE) (pp_name "lfence" U8).
Definition Ox86_MFENCE_instr :=
  mk_instr_pp "MFENCE" [::] [::] [::] [::] MSB_CLEAR (ok tt) [:: [::] ] 0 U8 (PrimM MFENCE) (pp_name "mfence" U8).
Definition Ox86_SFENCE_instr :=
  mk_instr_pp "SFENCE" [::] [::] [::] [::] MSB_CLEAR (ok tt) [:: [::] ] 0 U8 (PrimM SFENCE) (pp_name "sfence" U8).
...
Definition Ox86_PCLMULQDQ_instr := 
  mk_instr_pp "PCLMULQDQ" [:: sword U128; sword U128; sword U8] (w_ty U128)
    ...
    (check_xmm_xmmm_imm8 U128) 3 U128 (PrimM PCLMULQDQ)
...
Definition Ox86_VPCLMULQDQ_instr := 
 (fun sz =>
   mk_instr (pp_sz "VPCLMULQDQ"%string sz) [:: sword sz; sword sz; sword U8] (w_ty sz)
       ...
       (check_xmm_xmm_xmmm_imm8 sz) 4 U128 [::] (pp_name "vpclmulqdq" sz)
