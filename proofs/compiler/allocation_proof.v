...
Section PROOF.
  ...
  Proof.
    ...
    move => Hr2.
    exists vm1.
    + by apply eq_alloc_incl with (r1:= r1'); auto; subst r1';apply M.incl_refl.
  ...
  Section REFL.
    ...
    Proof.
      ...
      move=> /(sem_Ind Hskip Hcons HmkI Hassgn Hopn Hsyscall Hassert_true Hassert_false Hif_true Hif_false
