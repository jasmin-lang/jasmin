...
Definition is_Lsyscall_r (i : linstr_r) : option syscall_t :=
  if i is Lsyscall s then Some s else None.

Definition is_Lsyscall (i : linstr) : option syscall_t :=
  is_Lsyscall_r i.(li_i).
