...
Lemma safety_cond_holds_truncate tin vs vs' c :
  mapM2 ErrType truncate_val tin vs = ok vs' ->
  safety_cond_wf tin c ->
  safety_cond_holds vs' c = safety_cond_holds vs c.
Proof. by move=> h1 /safety_cond_wf_wt h2; rewrite /safety_cond_holds (safety_cond_truncate h1 h2). Qed.
...
by apply: (safety_cond_holds_truncate htr (allP hall _ hc)).
Qed.
