(* * Total semantics of the operators [sop1], [sop2] and [opN].
   ...
   The conditions under which the two agree are the safety conditions of
   [op_semi.v]; [sem_op_typed.v] rebuilds the partial semantics from the
   total one and from them. *)
...
(* -------------------------------------------------------------------- *)
(* ** The predicates of the safety conditions                            *)
