...
| Eassert_true ii k s t e:
    sem_pexpr gd s e = ok (Vbool true) →
    sem_i ii k s (Cassert t e) s

| Eassert_false ii k s t e:
...
Lemma sem_iE ii k s i s' :
  ...
  | Cassert t e =>
      exists b, sem_pexpr gd s e = ok (Vbool b)
  | Cif e c1 c2 =>
...
Section SEM_IND.
  ...
  Definition sem_Ind_assert_true: Prop :=
    ∀ (ii: instr_info) (k: Sv.t) (s : estate) (t: annotation_kind) (e : pexpr),
      sem_pexpr gd s e = ok (Vbool true) →
      Pi_r ii k s (Cassert t e) s.
  ...
  with sem_i_Ind (ii: instr_info) (k: Sv.t) (e : estate) (i : instr_r) (e0 : estate) (s : sem_i ii k e i e0) {struct s} :
    ...
    | @Eassert_true ii k s t e h => @Hassert_true ii k s t e h
    | @Eassert_false ii k s t e h => @Hassert_false ii k s t e h
