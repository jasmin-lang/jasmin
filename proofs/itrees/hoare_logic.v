...
Lemma hoare_while_full I I' Qerr ii al e c c' :
...
Lemma hoare_while I I' Qerr ii al e c c' :
  (forall s e, I' s -> Qerr e -> rInvErr s e) ->
  hoare I c I' ->
  rhoare I' (sem_cond (p_globs p) e) (fun _ => True) Qerr  ->
  hoare I' c' I ->
...
Lemma whoare_while_full I I' ii al e c c' :
  whoare p ev I c I' ->
  rhoare I' (sem_cond (p_globs p) e) (fun _ => True) PredT  ->
  whoare p ev (fun s => I' s /\ sem_cond (p_globs p) e s = ok true) c' I ->
  whoare p ev I [:: MkI ii (Cwhile al c e c')]
     (fun s => I' s /\ sem_cond (p_globs p) e s = ok false).
Proof. by apply hoare_while_full. Qed.

Lemma whoare_while I I' ii al e c c' :
  whoare p ev I c I' ->
  rhoare I' (sem_cond (p_globs p) e) (fun _ => True) PredT  ->
  whoare p ev I' c' I ->
  whoare p ev I [:: MkI ii (Cwhile al c e c')] I'.
