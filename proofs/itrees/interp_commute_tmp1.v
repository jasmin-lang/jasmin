...
Definition rjhnd3Br : (D1 +' D2) ~> itree ((D1 +' D2) +' (D2 +' E)) :=
  fun T d => match d with
             | inl1 d1 =>
                 translate pad_recev (Hnd1 d1)
             | inr1 d2 => translate pad_move (trigger (inl1 (inr1 d2))) end.
