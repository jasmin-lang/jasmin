...
Fixpoint esem_i (iiT: instr_info -> bool) (p : prog) (ev : extra_val_t) (i : instr) (s : estate) :
    exec estate :=
  let: (MkI ii i) := i in
  match i with
