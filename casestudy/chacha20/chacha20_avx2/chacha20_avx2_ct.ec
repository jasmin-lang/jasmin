...
module M = {
  ...
  proc init_x2 (key:W64.t, nonce:W64.t, counter:W32.t) : W256.t Array4.t = {
    ...
    aux <- g_p0;
    nc <- aux;
    aux <- VPINSR_4u32 nc counter (W8.of_int 0);
    nc <- aux;
    leakages <- LeakAddr([LeakageModel.leak_mem ((W64.to_uint (nonce + (W64.of_int 0))))]) :: leakages;
    aux <- VPINSR_4u32 nc
    (loadW32 Glob.mem (W64.to_uint (nonce + (W64.of_int 0)))) (W8.of_int 1);
    nc <- aux;
    leakages <- LeakAddr([LeakageModel.leak_mem ((W64.to_uint (nonce + (W64.of_int 4))))]) :: leakages;
    aux <- VPINSR_2u64 nc
    (loadW64 Glob.mem (W64.to_uint (nonce + (W64.of_int 4)))) (W8.of_int 1);
    nc <- aux;
    aux <- nc;
    s_nc <- aux;
    aux_0 <- VPBROADCAST_2u128 g_sigma;
    leakages <- LeakAddr([0]) :: leakages;
    st.[0] <- aux_0;
    leakages <- LeakAddr([LeakageModel.leak_mem ((W64.to_uint (key + (W64.of_int 0))))]) :: leakages;
    aux_0 <- VPBROADCAST_2u128 (loadW128 Glob.mem (W64.to_uint (key + (W64.of_int 0))));
    leakages <- LeakAddr([1]) :: leakages;
    st.[1] <- aux_0;
    leakages <- LeakAddr([LeakageModel.leak_mem ((W64.to_uint (key + (W64.of_int 16))))]) :: leakages;
    aux_0 <- VPBROADCAST_2u128 (loadW128 Glob.mem (W64.to_uint (key + (W64.of_int 16))));
    leakages <- LeakAddr([2]) :: leakages;
    st.[2] <- aux_0;
    aux_0 <- VPBROADCAST_2u128 s_nc;
  ...
  proc init_x8 (key:W64.t, nonce:W64.t, counter:W32.t) : W256.t Array16.t = {
    ...
    aux <- counter;
    s_counter <- aux;
    aux_0 <- VPBROADCAST_8u32 g_sigma0;
    leakages <- LeakAddr([0]) :: leakages;
    st.[0] <- aux_0;
    aux_0 <- VPBROADCAST_8u32 g_sigma1;
    leakages <- LeakAddr([1]) :: leakages;
    st.[1] <- aux_0;
    aux_0 <- VPBROADCAST_8u32 g_sigma2;
    leakages <- LeakAddr([2]) :: leakages;
    st.[2] <- aux_0;
    aux_0 <- VPBROADCAST_8u32 g_sigma3;
    leakages <- LeakAddr([3]) :: leakages;
    st.[3] <- aux_0;
    leakages <- LeakFor(0,8) :: LeakAddr([]) :: leakages;
    i <- 0;
    while (i < 8) {
      leakages <- LeakAddr([LeakageModel.leak_mem ((W64.to_uint (key + (W64.of_int (i * 4)))))]) :: leakages;
      aux_0 <- VPBROADCAST_8u32 (loadW32 Glob.mem (W64.to_uint (key + (W64.of_int (i * 4)))));
      leakages <- LeakAddr([(i + 4)]) :: leakages;
      st.[(i + 4)] <- aux_0;
      i <- i + 1;
    }
    aux_0 <- VPBROADCAST_8u32 s_counter;
    ...
    i <- 0;
    while (i < 3) {
      leakages <- LeakAddr([LeakageModel.leak_mem ((W64.to_uint (nonce + (W64.of_int (i * 4)))))]) :: leakages;
      aux_0 <- VPBROADCAST_8u32 (loadW32 Glob.mem (W64.to_uint (nonce + (W64.of_int (i * 4)))));
  ...
  W64.t * W64.t * W32.t * W256.t Array2.t = {
    ...
    leakages <- LeakAddr([0]) :: leakages;
    k.[0] <- aux;
    leakages <- LeakAddr([LeakageModel.leak_mem ((W64.to_uint (plain + (W64.of_int 32))))]
                         ++ [1]) :: leakages;
    ...
    leakages <- LeakAddr([1]) :: leakages;
    aux <- k.[1];
    leakages <- LeakAddr([LeakageModel.leak_mem ((W64.to_uint (output + (W64.of_int 32))))]) :: leakages;
    Glob.mem <-
  ...
  proc store_last (output:W64.t, plain:W64.t, len:W32.t, k:W256.t Array2.t) : unit = {
    ...
    aux_3 <- VEXTRACTI128 r0 (W8.of_int 0);
    r1 <- aux_3;
    ...
    if (((W32.of_int 16) \ule len)) {
      ...
      plain <- aux_0;
      len <- aux_2;
      aux_3 <- VEXTRACTI128 r0 (W8.of_int 1);
      r1 <- aux_3;
    } else {
  ...
  W64.t * W64.t * W32.t * W256.t Array4.t = {
    ...
    i <- 0;
    while (i < 4) {
      leakages <- LeakAddr([LeakageModel.leak_mem ((W64.to_uint (plain + (W64.of_int (32 * i)))))]
                           ++ [i]) :: leakages;
    ...
    while (i < 4) {
      leakages <- LeakAddr([i]) :: leakages;
      aux_0 <- k.[i];
      leakages <- LeakAddr([LeakageModel.leak_mem ((W64.to_uint (output + (W64.of_int (32 * i)))))]) :: leakages;
      Glob.mem <-
