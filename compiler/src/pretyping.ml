...
module Env : sig
  ...
  module Vars : sig
    ...
    val push_local    : 'asm env -> P.var * P.ety -> 'asm env
  ...
  module Vars = struct
    ...
    let push_core (env : 'asm env) (name: P.Name.t) (v : P.var) (ty: P.ety) (s : E.v_scope)  =
      let doit m =
    ...
    let push_local (env : 'asm env) ((v,ty) : P.var * P.ety) =
