...
module MEnv = struct
  ...
  type 'asm menv =
    ...
    ; me_ldecls : (P.pexpr_, unit, 'asm) M.gmodule_item list list (* declarations from current modules *)
    ; me_gdecls : (P.pexpr_, unit, 'asm) M.gmodule_item list (* global declarations *)
