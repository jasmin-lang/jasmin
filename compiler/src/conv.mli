...
val expr_of_cexpr :  Expr.pexpr -> Prog.expr

val cufdef_of_fdef :  (unit, 'asm) func -> Var0.funname * ('asm, unit) Expr._fundef
val fdef_of_cufdef :  Var0.funname * ('asm, unit) Expr._fundef -> (unit, 'asm) func

val cuprog_of_prog : (unit, 'asm) prog -> ('asm, unit, unit) Expr._prog
val prog_of_cuprog :   ('asm, unit, unit) Expr._prog -> (unit, 'asm) prog
