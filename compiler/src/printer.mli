...
val pp_instr : debug:bool ->
               ...
               Format.formatter -> (E.sop1, E.sop2, 'info, ('reg, 'regx, 'xreg, 'rflag, 'cond, 'asm_op, 'extra_op) Arch_extra.extended_op) instr -> unit

val pp_stmt  : debug:bool ->
               Wsize.wsize ->
               ('reg, 'regx, 'xreg, 'rflag, 'cond, 'asm_op, 'extra_op) Arch_extra.extended_op Sopn.asmOp ->
               Format.formatter -> (E.sop1, E.sop2, 'info, ('reg, 'regx, 'xreg, 'rflag, 'cond, 'asm_op, 'extra_op) Arch_extra.extended_op) stmt  -> unit
...
val pp_fun :
             ...
             var Utils.pp ->
             ((E.sop1, E.sop2, 'info, ('reg, 'regx, 'xreg, 'rflag, 'cond, 'asm_op, 'extra_op) Arch_extra.extended_op) func) Utils.pp

val pp_ifunc : debug:bool -> (Location.i_loc * 'info) Utils.pp ->
               Wsize.wsize ->
               ('reg, 'regx, 'xreg, 'rflag, 'cond, 'asm_op, 'extra_op) Arch_extra.extended_op Sopn.asmOp ->
               Format.formatter -> (E.sop1, E.sop2, 'info, ('reg, 'regx, 'xreg, 'rflag, 'cond, 'asm_op, 'extra_op) Arch_extra.extended_op) func -> unit
