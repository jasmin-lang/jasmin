...
val pp_pprog : Wsize.wsize -> ('reg, 'regx, 'xreg, 'xregx, 'rflag, 'cond, 'asm_op, 'extra_op) Arch_extra.extended_op Sopn.asmOp ->
               Format.formatter -> ('info, ('reg, 'regx, 'xreg, 'xregx, 'rflag, 'cond, 'asm_op, 'extra_op) Arch_extra.extended_op) pprog -> unit
...
val pp_instr : debug:bool ->
               Wsize.wsize ->
               ('reg, 'regx, 'xreg, 'xregx, 'rflag, 'cond, 'asm_op, 'extra_op) Arch_extra.extended_op Sopn.asmOp ->
               Format.formatter -> ('info, ('reg, 'regx, 'xreg, 'xregx, 'rflag, 'cond, 'asm_op, 'extra_op) Arch_extra.extended_op) instr -> unit

val pp_stmt  : debug:bool ->
               Wsize.wsize ->
               ('reg, 'regx, 'xreg, 'xregx, 'rflag, 'cond, 'asm_op, 'extra_op) Arch_extra.extended_op Sopn.asmOp ->
               Format.formatter -> ('info, ('reg, 'regx, 'xreg, 'xregx, 'rflag, 'cond, 'asm_op, 'extra_op) Arch_extra.extended_op) stmt  -> unit

val pp_ifunc : debug:bool -> (Format.formatter -> 'info -> unit) ->
               Wsize.wsize ->
               ('reg, 'regx, 'xreg, 'xregx, 'rflag, 'cond, 'asm_op, 'extra_op) Arch_extra.extended_op Sopn.asmOp ->
               Format.formatter -> ('info, ('reg, 'regx, 'xreg, 'xregx, 'rflag, 'cond, 'asm_op, 'extra_op) Arch_extra.extended_op) func -> unit
...
val pp_iprog : debug:bool -> (Format.formatter -> 'info -> unit) ->
               Wsize.wsize ->
               ('reg, 'regx, 'xreg, 'xregx, 'rflag, 'cond, 'asm_op, 'extra_op) Arch_extra.extended_op Sopn.asmOp ->
               Format.formatter -> ('info, ('reg, 'regx, 'xreg, 'xregx, 'rflag, 'cond, 'asm_op, 'extra_op) Arch_extra.extended_op) prog -> unit
...
val pp_sprog : debug:bool ->
               Wsize.wsize ->
               ('reg, 'regx, 'xreg, 'xregx, 'rflag, 'cond, 'asm_op, 'extra_op) Arch_extra.extended_op Sopn.asmOp ->
               Format.formatter -> ('info, ('reg, 'regx, 'xreg, 'xregx, 'rflag, 'cond, 'asm_op, 'extra_op) Arch_extra.extended_op) sprog -> unit
